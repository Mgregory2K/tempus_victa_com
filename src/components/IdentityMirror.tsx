    ...
    return (
        <div className="max-w-7xl mx-auto space-y-10 animate-slide-up pb-20 px-4">
            <header className="flex justify-between items-end border-b border-white/10 pb-6 relative">
                <div className="absolute -top-10 -left-10 opacity-5 pointer-events-none text-[60px] font-black italic select-none uppercase">AFFINITY</div>
                <div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                {/* LEFT COLUMN: PRIMARY IDENTITY CONTENT */}
                <div className="lg:col-span-2 space-y-8">
                    {/* COGNITIVE DNA */}
                    <div className="hud-panel p-8 bg-black/60 border-white/10 relative overflow-hidden group">
                    ...
                    {/* SOVEREIGNTY METRICS STACKED */}
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                         <div className="hud-panel p-6 bg-neon-green/5 border-neon-green/20 relative group overflow-hidden">
                            <div className="absolute -right-4 -bottom-4 text-6xl font-black text-neon-green/10 italic uppercase">FREE</div>
                    ...
                    <div className="hud-panel p-10 bg-black/40 border-white/5 relative border-dashed border-2">
                        <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 px-6 bg-black border border-white/10 system-text text-[9px] font-black text-white/40 tracking-[0.5em] uppercase whitespace-nowrap">Learned Laws of Sovereignty</div>
                ...
                <div className="space-y-8 overflow-y-auto max-h-[80vh] scrollbar-thin pr-2">
                    <div className="hud-panel border-white/10 bg-black/40 overflow-hidden">
                        <div className="p-4 border-b border-white/5 bg-white/[0.02]">
                            <h3 className="system-text text-[10px] text-white/40 font-black uppercase tracking-[0.3em]">Temporal Ledger</h3>
                        </div>
                        <div className="scale-90 origin-top">
                            <Winboard externalTasks={externalTasks} setExternalTasks={setExternalTasks} />
                        </div>
                    </div>
